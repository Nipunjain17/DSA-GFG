<h2><a href="https://www.geeksforgeeks.org/problems/implement-atoi/1?page=1&category=Strings&status=unsolved&sortBy=submissions">Implement Atoi</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a string <strong>s</strong>, the objective is to <strong>convert</strong> it into <strong>integer format</strong> without utilizing any built-in functions. Refer the below steps to know about <strong>atoi()</strong> function.</span></p>
