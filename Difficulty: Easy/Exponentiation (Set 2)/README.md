<h2><a href="https://www.geeksforgeeks.org/problems/abset-25327/1?page=4&sortBy=submissions">Exponentiation (Set 2)</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">For two given positive numbers a and b. Find a<sup>b</sup>. Output your number modulus 10<sup>9</sup>+7.</span></p>
